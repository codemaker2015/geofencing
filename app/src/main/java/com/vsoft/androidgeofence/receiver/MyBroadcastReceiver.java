package com.vsoft.androidgeofence.receiver;
...
import com.vsoft.androidgeofence.activity.GeofencingActivity;
...
public class MyBroadcastReceiver extends BroadcastReceiver {
    ...
    private void handleGeoEvent(Context context, Geofence geofence, String event) {
        ...
        context.sendBroadcast(new Intent("com.vsoft.experiment.ACTION_GEO_CHANGED"));
